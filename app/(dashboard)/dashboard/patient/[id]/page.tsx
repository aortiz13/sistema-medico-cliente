...
export default function PatientProfilePage() {
  ...
  const { createManualConsultation } = useConsultations();
  ...
  const handleSaveManualNote = async () => {
    ...
    const created = await createManualConsultation(patient.id, profile.id, newNote);
    if (created) {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              <div className="lg:col-span-1 space-y-8">
                ...
                <div className="bg-base-100 rounded-xl shadow-soft border border-base-300 p-6">
                  <h2 className="text-xl font-bold text-text-primary mb-4">Agregar Nota Manual</h2>
                  {isAddingNote ? (
